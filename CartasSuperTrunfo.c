...
int main (){
    ...
    pibpercapita1 = (pib1 * 1000000000) / populacao1;  // Calcula o PIB per Capita (* 1000000000 Converte bilhões para reais)
    ...
    pibpercapita2 = (pib2 * 1000000000)  / populacao2;  // Calcula o PIB per Capita, (* 1000000000 Converte bilhões para reais)
